...
public void getCartdetails()
{
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if(task.isSuccessful()){
                        for(DocumentSnapshot document:task.getResult()){
                            ...
                            if(cart_products.getUser_name().equals("saikiran848@gmail.com"))
                            {
    ...
    public void onClick(View v) {
        ...
        sendOrder("saikiran848@gmail.com",products,total);

    }

    public void sendOrder(String username,ArrayList<String> products,double total){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy.MM.dd G 'at' HH:mm:ss z");
        String currentDateandTime = sdf.format(new Date());
        SendOrder new_order=new SendOrder(username,products,currentDateandTime,total);
